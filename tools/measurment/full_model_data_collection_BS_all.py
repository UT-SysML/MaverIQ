...
with open(f'{HOME_DIRECTORY}/outputs/profiling_data/full_model_data_collection_BS.csv', mode='w', newline='') as file:
    ...
    for model_ in ['gptj-6b', 'falcon-40b']:#['falcon-7b', 'falcon-40b', 'gptj-6b', 'llama-2-7b', 'llama-2-13b', 'llama-2-70b']:
        print(f'\n---------- {model_} ----------')
        ...
        for (tp_deg_, pp_deg_, dtype_, int8_kv_) in configs_list:
            ...
            for batch_size_ in [1, 8, 16, 32, 64]:
                ...
                for output_lenght_ in [50, 100, 200]:
                    time_profiling = 0
